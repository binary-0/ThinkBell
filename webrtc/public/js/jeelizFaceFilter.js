  ...
  var JEELIZFACEFILTER = (function() {
    window.JEELIZFACEFILTERGEN = function() {
        ...
        function Ib(a) {
            ...
            var d = c.nf,
                e = c.n;
            var m = "undefined" === typeof btoa ? Buffer.from(c.data, "base64").toString("latin1") : atob(c.data);
            var n = m.length;
            c = new Uint8Array(n);
            ...
            q = a + d +
                1;
            for (var r = 0; r < e; ++r) {
                for (var l = q * r, v = 0 === db(c, l) ? 1 : -1, C = l + 1, E = 1, g = 0, t = C + a - 1; t >= C; --t) g += E * db(c, t), E *= 2;
                C = g;
                l = l + 1 + a;
                E = n.length;
                g = 0;
                ...
                m[r] = 0 === l && 0 === C ? 0 : v * (1 + l) * Math.pow(2, 1 + C - Math.pow(2, a - 1))
            }
            return m
        }
        ...
        function qb() {
            na !== ia.pause && (ea.isCleanGLStateAtEachIteration && (A.ad(), U.reset(), U.Ja(), b.disable(b.DEPTH_TEST), b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1), A.Ba()), pa.rc(Kb,
                Jb, Lb, Mb, ea.animateProcessOrder))
        }

        function Kb() {
            va.ha();
            if (!B.kb)
                if (B.jb) B.element.needsUpdate && (B.N.Rf(B.element.arrayBuffer), B.element.needsUpdate = !1);
                else {
            ...
            if (O.W.length > a) O.W.splice(0, O.W.length - a);
                ...
                for (; O.W.length < a;) O.W.push(0);
            if (1 !== O.o)
                if (qa.every(Nb)) {
                    for (var d = 0, e = c = 0; e < qa.length; ++e) qa[e].detected > d && (d = qa[e].detected, c = 0);
                    ...
                    for (var m = e = 0; e < a; ++e) {
                        if (!gb(qa[d]) && ++m > c) {
                            do ++d === O.o && (d = 0); while (!gb(qa[d]))
                        }
                        O.W[e] = d++;
                        d %= O.o
                    }
                    O.Fd = d
                } for (a = 0; a < pa.od(); ++a) O.pa = O.W[a], O.mc = (.5 + O.pa) / O.o, O.Ad = O.W.lastIndexOf(O.pa) === a, A.set("s55"), c = qa[O.pa], A.G("u43", 1 + Na.uc * (Math.cos(c.ry) - 1)), Q.ua && A.G("u42", c.rz), 1 !== O.o && A.G("u41", O.mc), Z.xa.da(), B.N.g(0), X.Da.g(1), U.l(!1, !1), Z.xa.g(0), Oa.V(Z.xa);
            pa.ae()
        }
        ...
        function Lb() {
            for (var a = 0; a < O.o; ++a)
                if (-1 !== O.W.indexOf(a)) {
                    ...
                    if (d.Wa < ea.multiDetectionThresholdFactors[0] * ea.threshold) d.Aa = Math.floor(d.Aa / 2), Q.ua && (m.rz = 0, m.ry = 0);
                    else {
                        var r = X.Pa;
                        d.x = Fa(0, q, 1, -1, 1);
                        d.y = Fa(0, q, 2, -1, 1);
                        ...
                        q = pa.Qe();
                        e = (1 - Za.qb(sa.translationFactorRange[0], sa.translationFactorRange[1],
                            Math.sqrt(e.Rb * e.Rb + e.Sb * e.Sb + e.Qb * e.Qb) / q)) * (1 - Za.qb(sa.rotationFactorRange[0], sa.rotationFactorRange[1], Math.sqrt(e.Nb * e.Nb + e.Ob * e.Ob + e.Pb * e.Pb) / q)) * Za.qb(sa.qualityFactorRange[0], sa.qualityFactorRange[1], d.Wa);
                        c = n[++ib[c] % n.length] = e;
                        ...
                        m.ry = wa.$(m.ry, d.tc, n);
                        m.rz =
                            Q.ua ? m.rz + sa.followZRotAlphaFactor * n * d.Qa : wa.$(m.rz, d.Qa, n);
                        ...
                        m.s = m.sRaw;
                        n = Math.max(n, ba.le);
                        for (c = 0; c < X.aa; ++c) m.expressions[c] = wa.$(m.expressions[c], d.hd[c], n);
                        ++d.Aa
                    }
                } va.Pf();
            ea.isCleanGLStateAtEachIteration && (va.reset(), Y.reset(), b.enable(b.DEPTH_TEST));
        ...
        function sb() {
            ...
            for (var a = ba.Yd, c = O.o, d = new Float32Array([0, .5, .5, 0, 0, 0, 0, 0, 0, 0, 0, 0]), e = new Float32Array(d.length * O.o), m = 0, n; m < O.o; ++m)
        ...
        function Pb() {
            function a(c) {
                for (var d = [], e = 0; e < O.o; ++e) d.push(JSON.parse(JSON.stringify(c)));
                return d
            }
        ...
        function Qb(a) {
            if (Q.Fa) ub("string" === typeof Q.Fa ? JSON.parse(Q.Fa) : Q.Fa, a);
                ...
                var c =
                    Q.Mc;
                "JSON" !== c.toUpperCase().split(".").pop() && (c += ba.neuralNetworkPath);
                vb.get(c, function(d) {
                    d = JSON.parse(d);
                    ub(d, a)
                })
        ...
        function ub(a, c) {
            if (a.exportData) {
                ...
                "undefined" !== typeof d.fgDisplaceXFactor && (Na.Mb = d.fgDisplaceXFactor)
            }
            X.aa ||
                (X.aa = ba.Jd);
            if (!X.Na)
                for (X.Na = [], d = 0; d < X.aa; ++d) X.Na.push(ba.Ke);
            c(a)
        }
        ...
        function wb(a, c, d, e) {
            return d > a ? Math.max(0, a + c / 2 - (d - e / 2)) : Math.max(0, d + e / 2 - (a - c / 2))
        }
        ...
        function Sb() {
            return Sa.some(function(a, c) {
                if (c === O.pa) return !1;
                c = Sa[O.pa];
                if (c.Aa > a.Aa || 3 > a.Aa || wb(c.x, c.ca, a.x, a.ca) < ba.Hd * c.ca) return !1;
                var d = Z.D / Z.M;
        ...
        function Tb() {
            var a = O.pa;
            X.Da.Bf(1);
            1 !== O.o && (b.viewport(0, 0, 3, O.o), A.set("s0"), A.Xd("u1", 1), U.l(!1, !1), A.Xd("u1", 0));
            b.viewport(0, a, 1, 1);
            A.set("s56");
            ...
            A.Gf("u45", tb.get());
            U.l(!1, !1);
            O.Ad && (b.viewport(1, a, 1, 1), A.set("s57"), A.G("u49", 1), U.l(!1, !1), b.viewport(2, a, 1, 1), A.set("s58"),
                U.l(!1, !1))
        }
        ...
        function yb() {
            ...
            if (!a.w || !a.wa || 4 > a.w || 4 > a.wa) throw Error("INVALID VIDEO DIMENSIONS - width = " +
                a.w + " height = " + a.wa);
            return a
        }
        ...
        function zb(a, c, d) {
            ...
            W.get(B.element ? B.element : W.Ze(), function(e) {
                    c && c(e);
                    d(e)
                }, function() {
        ...
        var wa = {
            ...
            Vb = {
                Me: function(a, c, d) {
                    switch (a) {
                        ...
                        case "elu":
                            return d + "=mix(exp(-abs(" +
                                c + "))-vec4(1.,1.,1.,1.)," + c + ",step(0.," + c + "));";
                        case "elu01":
            ...
            A = function() {
                ...
                function d(u, f) {
                    f.C = f.C ? !0 : !1;
                    if (!f.C) {
                        void 0 === f.ta && (f.ta = "precision lowp float;attribute vec2 a0;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=a0*.5+vec2(.5,.5);}");
                        void 0 === f.Ta && (f.Ta = ["a0"]);
                        void 0 === f.Ha && (f.Ha = [2]);
                        if (void 0 === f.precision || "highp" === f.precision) f.precision = E;
                        f.id = v++;
                        void 0 !== f.Vd && (f.Vd.forEach(function(G, L) {
                ...
                function e(u) {
                    xa.Ff(M);
                    r !== u.id && (M.R(), r = u.id, l = u, b.useProgram(u.ra), u.Ia.forEach(function(f) {
                ...
                var q = [],
                    ...
                    M = {
                        ...
                        sd: function(u, f, y) {
                            ...
                            z[f].ef = !0;
                            J[u].yb && J[u].yb.forEach(function(G, L) {
                        ...
                        R: function() {
                            -1 !== r && (r = -1, l.Ia.forEach(function(u) {
                ...
                var e = null,
                    ...
                    E = {
                        ...
                        Jg: function() {
                            ...
                            m.width = e.width;
                            m.height = e.height;
                            for (var g = E.Pe(), t = n.createImageData(m.width, m.height), x = m.width, k = m.height, p = t.data, H = 0; H < k; ++H)
                        ...
                        Hg: function(g) {
                            !m && g && (m = document.createElement("canvas"), n = m.getContext("2d"));
                            var t = g ? m : document.createElement("canvas");
                            t.width = e.width;
                            t.height = e.height;
                            (g ? n : t.getContext("2d")).drawImage(e,
                                0, 0);
                            return t
                        },
                        A: function(g) {
                            g.Ce && !g.Jb ? e = document.getElementById(g.Ce) : g.Jb && (e = g.Jb);
                            ...
                            if (b) r = b instanceof WebGL2RenderingContext;
                                ...
                                navigator && navigator.userAgent && -1 !== navigator.userAgent.indexOf("noAntialiasing") && (t.antialias = !1);
                                var x = c(t);
                                !x && t.antialias && (t.antialias = !1, x = c(t));
                                x && (b = e.getContext("webgl2", t));
                                b ? r = !0 : ((b = e.getContext("webgl", t)) || (b = e.getContext("experimental-webgl", t)), r = !1)
                            }
                            if (!b) return a("WebGL1 and 2 are not enabled");
                            (q = b.getExtension("WEBGL_lose_context")) && g.Ld && (v = g.Ld, e.addEventListener("webglcontextlost", v, !1));
                        ...
                        m: function() {
                            b && (aa.m(), A.m(), Ca.m());
                            q && v && (e.removeEventListener("webglcontextlost", v, !1), q = v = null);
                            b = l = n = m = e = null;
                            C.splice(0)
                        }
                    };
            ...
            xa = function() {
                function a() {
                    null === c && ("undefined" !== typeof A ? c = A : "undefined" !== typeof JEShaders && (c = JEShaders))
                }
                var c = null;
                a();
                return {
            ...
            Ba = function() {
                ...
                function c(h) {
                    ...
                    var F = h >> 16 & 32768,
                        K = h >> 12 & 2047,
                        P = h >> 23 & 255;
                    return 103 > P ? F : 142 < P ? F | 31744 | ((255 == P ? 0 : 1) && h & 8388607) : 113 > P ? (K |= 2048, F | (K >> 114 - P) + (K >> 113 - P & 1)) : F = (F |
                        P - 112 << 10 | K >> 1) + (K & 1)
                }
                ...
                var q = 0,
                    ...
                    L = {
                        A: function() {
                            k || (t = [b.RGBA, null, b.RGBA, b.RGBA], x = [b.RGBA, null, b.RGBA, b.RGBA], r = [b.TEXTURE0, b.TEXTURE1, b.TEXTURE2, b.TEXTURE3, b.TEXTURE4, b.TEXTURE5, b.TEXTURE6, b.TEXTURE7], M = "undefined" !== typeof JEContext, u = "undefined" !== typeof aa, M && JEContext.gh() && r.push(b.TEXTURE8,
                                b.TEXTURE9), v = [-1, -1, -1, -1, -1, -1, -1, -1], g = [b.UNSIGNED_BYTE, b.FLOAT, b.FLOAT], k = !0)
                        },
                        af: function() {
                            if (!C) {
                                for (var h = new Float32Array(16384), F = 0; 16384 > F; ++F) h[F] = 2 * Math.random() - 1;
                                C = {
                                    random: L.instance({
                                        isFloat: !0,
                                        isPot: !0,
                        ...
                        kd: function(h, F, K, P, da, ra, za) {
                            ...
                            h.texParameteri(h.TEXTURE_2D, h.TEXTURE_MAG_FILTER,
                                h.NEAREST);
                            h.texParameteri(h.TEXTURE_2D, h.TEXTURE_MIN_FILTER, h.NEAREST);
                            h.pixelStorei(h.UNPACK_FLIP_Y_WEBGL, ra);
                            h.texImage2D(h.TEXTURE_2D, 0, h.RGBA, K, P, 0, h.RGBA, h.FLOAT, da);
                            h.bindTexture(h.TEXTURE_2D, null);
                            h.pixelStorei(h.UNPACK_FLIP_Y_WEBGL, !1);
                            za && (la.ha(), A.Ra(h));
                            h.viewport(0, 0, K, P);
                            h.framebufferTexture2D(h.FRAMEBUFFER, h.COLOR_ATTACHMENT0, h.TEXTURE_2D, F, 0);
                            h.bindTexture(h.TEXTURE_2D, w);
                            za ? ma.l(!0, !0) : U.ab(h);
                            h.deleteTexture(w);
                            k && (v[0] = -1, E = null, q = 0)
                        ...
                        instance: function(h) {
                            ...
                            function K(D) {
                                ...
                                S = b.getError();
                                S !== b.NO_ERROR && fa !== b.RGBA && (fa = b.RGBA, b.texImage2D(b.TEXTURE_2D, 0, ja, fa, ha, D));
                                return !0
                            }
                            ...
                            function P() {
                                if (!Ab) {
                                    ...
                                    w.isPot ? (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, w.isMirrorX ? b.MIRRORED_REPEAT :
                                        b.REPEAT), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, w.isMirrorY ? b.MIRRORED_REPEAT : b.REPEAT)) : (b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE), b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE));
                                    w.isAnisotropicFiltering && "undefined" !== typeof JESETTINGS && b.texParameterf(b.TEXTURE_2D, JEContext.Kg().TEXTURE_MAX_ANISOTROPY_EXT, JESETTINGS.Wf);
                                    b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, w.isLinear ? b.LINEAR : b.NEAREST);
                                    w.isLinear ? b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER,
                                        w.isMipmap && !Ka ? b.NEAREST_MIPMAP_LINEAR : b.LINEAR) : b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, w.isMipmap && !Ka ? b.NEAREST_MIPMAP_NEAREST : b.NEAREST);
                                    fa = t[w.sb - 1];
                                    ja = x[w.sb - 1];
                                    ha = g[nb];
                                    if (aa.la()) {
                                        var D = aa.Re();
                                        fa === b.RGBA && ha === b.FLOAT ? w.isMipmap || w.isLinear ? ja = Ca.Te(b) : aa.Uc() ? D && (ja = D) : ja = b.RGBA16F || b.RGBA : fa === b.RGB && ha === b.FLOAT && D && (ja = D, fa = b.RGBA)
                                    }
                                    if (w.S && !w.isFloat || w.isFloat && w.isMipmap && Ca.hf()) ja = aa.Se(), ha = aa.Vb(b);
                                    w.ic && (ab = w.ic);
                                    ...
                                    if (w.I) K(w.I);
                                        ...
                                        D = ua;
                                        try {
                                            "FUCKING_BIG_ERROR" !== b.getError() && (b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, D), b.getError() !== b.NO_ERROR && (b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, null), b.getError() !== b.NO_ERROR && b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, R, T, 0, b.RGBA, b.UNSIGNED_BYTE, null)))
                                        } catch (hc) {
                                            b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, null)
                                        }
                                        w.isKeepArray || (ua = null)
                                    } else D = b.getError(), "FUCKING_BIG_ERROR" !== D && (b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, null), D = b.getError(), D !== b.NO_ERROR &&
                                        (fa = b.RGBA, w.S && ha !== b.FLOAT && (ha = b.FLOAT, b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, null))));
                                    if (w.isMipmap)
                                        if (!Ka && ca) ca.Ub(), bb = !0;
                                        else if (Ka) {
                                        ...
                                        for (var S = 1; S <= D; ++S) {
                                            ...
                                            b.texImage2D(b.TEXTURE_2D, 0, ja, V, ka, 0, fa, ha, null);
                                            a(null);
                                            Ra[S] = La
                                        }
                                        bb = !0
                                    ...
                                    a(null);
                                    v[q] = -1;
                                    Aa && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,
                                        !1);
                                    Ta = !0;
                            ...
                            function da() {
                                for (var D = R * T, S = 2 * D, ka = 3 * D, V = 0; V < D; ++V) ya[0][V] = Ua[V], ya[1][V] = Ua[V + D], ya[2][V] = Ua[V + S], ya[3][V] = Ua[V + ka]
                            }

                            function ra() {
                                var D = R * T * 4;
                                Da = [new Uint8Array(D), new Uint8Array(D), new Uint8Array(D), new Uint8Array(D)];
                            ...
                            function za() {
                                ...
                                Ea.ld =
                                    new Float32Array(Ea.buffer);
                                Ea.Y = !0
                            }
                            var w = Object.assign({}, H, h),
                                Wa = l++;
                            null === w.isFlipY && (w.isFlipY = w.url || w.array ? !0 : !1);
                            w.data && (w.array = "string" === typeof w.data ? Ib(w.data) : w.isFloat ? new Float32Array(w.data) : new Uint8Array(w.data), w.isFlipY = !1);
                            var nb = 0,
                                Bb = w.I ? !0 : !1,
                                Xa = null,
                                ob = null,
                            ...
                            w.isFloat && (nb = 2);
                            w.isAnisotropicFiltering && M && !JEContext.$g() && (w.isAnisotropicFiltering = !1);
                            ...
                            var ca = {
                                ...
                                re: function(D,
                                    S) {
                                    Ka ? (D || (D = ca.pd()), L.Fb(S), a(Ra[D]), v[S] = -1) : ca.g(S)
                                },
                                pd: function() {
                                ...
                                Le: function(D) {
                                    if (Ka) {
                                        ...
                                        A.set("s12");
                                        L.Fb(0);
                                        for (var S = R, ka = T, V = 1; V <= D; ++V) S /= 2, ka /= 2, A.sa("u8", .25 / S, .25 / ka), b.viewport(0, 0, S, ka), a(Ra[V - 1]), b.framebufferTexture2D(la.eb(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D, Ra[V], 0), ma.l(!1, 1 === V);
                                        v[0] = -1
                                    } else ca.Ub()
                                },
                                vh: function(D) {
                                ...
                                u: function() {
                                    E = ca;
                                    b.framebufferTexture2D(la.eb(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D, ta, 0)
                                },
                                da: function() {
                                    E = ca;
                                    b.viewport(0, 0, R, T);
                                ...
                                refresh: function() {
                                    ...
                                    Bb ? b.texImage2D(b.TEXTURE_2D, 0, ja, fa, ha, w.I) : b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, ua);
                                ...
                                Zc: function(D) {
                                    ...
                                    A.set("s13");
                                    ca.g(0);
                                    if (D) b.viewport(0, 0, R, T), A.xc("u9", .25, .25, .25, .25), ma.l(!1, !0);
                                    else
                                        for (D = 0; 4 > D; ++D) b.viewport(0, T * D, R, T), A.xc("u9", J[D]), ma.l(!1, 0 === D)
                                },
                                Rf: function(D) {
                                    var S = ha === g[0] && !m();
                                    a(ta);
                                    Aa && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !0);
                                    S ? (Cb || (Xa = document.createElement("canvas"), Xa.width = R, Xa.height = T, ob = Xa.getContext("2d"),
                                        pb = ob.createImageData(R, T), Cb = !0), pb.data.set(D), ob.putImageData(pb, 0, 0), b.texImage2D(b.TEXTURE_2D, 0, ja, fa, ha, Xa)) : b.texImage2D(b.TEXTURE_2D, 0, ja, R, T, 0, fa, ha, D);
                                    v[q] = Wa;
                                    Aa && b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL, !1)
                                },
                                Gh: function(D, S) {
                                ...
                                th: function(D, S) {
                                    ...
                                    Va || ("RGBA" === D || "RGBE" === D || "RGBAARRAY" === D ? (Da = new Uint8Array(V), Va = !0) : "JSON" !== D || S || ra());
                                    la.P();
                                    A.set(La);
                                    ca.g(0);
                                    V = null;
                                    if ("RGBA" === D || "RGBE" === D || "RGBAARRAY" === D) {
                                        ...
                                        if ("RGBAARRAY" === D) return {
                                            data: Da
                                        };
                                        I || (N = document.createElement("canvas"), z = N.getContext("2d"), I = !0);
                                        N.width = R;
                                        N.height = T;
                                        ...
                                        if (S) V = new Float32Array(ka), b.viewport(0, 0, R, T), ma.l(!0, !0), b.readPixels(0, 0, R, T, b.RGBA, b.FLOAT, V);
                                        else {
                                            for (V = 0; 4 > V; ++V) b.viewport(0, T * V, R, T), A.xc("u9", J[V]), ma.l(!V, !V);
                                            ca.Rd();
                                            V = Array(ka);
                                            for (S = 0; S < ka; ++S) V[4 * S] = ya[0][S], V[4 * S + 1] = ya[1][S], V[4 * S + 2] = ya[2][S], V[4 * S + 3] = ya[3][S]
                                        } return {
                                        format: D,
                                        data: V,
                                        width: R,
                            ...
                            if (w.url) a(ta), b.texImage2D(b.TEXTURE_2D,
                                0, b.RGBA, 1, 1, 0, b.RGBA, b.UNSIGNED_BYTE, null), Ga = new Image, Ga.jg = "Anonymous", Ga.crossOrigin = "Anonymous", Ga.src = w.url, Ga.onload = function() {
                                R = Ga.width;
                                T = Ga.height;
                                P()
                            };
                                ...
                                Db()
                            } else w.array ? (w.S && !w.isFloat ? w.array instanceof Uint16Array ? (ua = w.array, P()) : e() ? (ua = d(w.array), P()) : (P(), L.kd(b, ta, ca.F(), ca.U(), w.array, Aa, !0)) : (ua = w.isFloat ? w.array instanceof Float32Array ? w.array : new Float32Array(w.array) : w.array instanceof Uint8Array ? w.array : new Uint8Array(w.array),
                                P()), w.isKeepArray || (ua && ua !== w.array && (ua = null), delete w.array)) : w.Zb ? Ta = !0 : P();
                            ca.Ug = ca.F;
                        ...
                        Fc: function() {
                            E = null;
                            b.framebufferTexture2D(la.eb(), b.COLOR_ATTACHMENT0, b.TEXTURE_2D, null, 0)
                        },
                        reset: function() {
            ...
            ma = function() {
                function a(l) {
                    ...
                    l.bufferData(l.ELEMENT_ARRAY_BUFFER,
                        new Uint16Array([0, 1, 2]), l.STATIC_DRAW);
                    return v
                }
                var c = null,
                    d = 0,
                    ...
                    r = {
                        ...
                        instance: function(l) {
                            ...
                            b.bufferData(b.ARRAY_BUFFER, l.ea instanceof Float32Array ? l.ea : new Float32Array(l.ea), E);
                            n = v;
                            var t = null,
                                x = null,
                                k = null;
                            if (l.K) {
                                ...
                                var p = null;
                                65536 >
                                    l.K.length ? (p = Uint16Array, x = b.UNSIGNED_SHORT, k = 2) : (p = Uint32Array, x = b.UNSIGNED_INT, k = 4);
                        ...
                        Ja: function() {
                            -1 !== n && (b.bindBuffer(b.ARRAY_BUFFER, c.ea), n = -1); - 1 !== q && (b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, c.K), q = -1)
                        },
                        l: function(l, v) {
                            l && ma.Ja();
                            v && xa.Ba();
                            ...
                            var p = {
                                ...
                                je: function() {
                                    ...
                                    b.bindRenderbuffer(b.RENDERBUFFER,
                                        g);
                                    b.renderbufferStorage(b.RENDERBUFFER, b.DEPTH_COMPONENT16, v, C);
                                    b.framebufferRenderbuffer(c, b.DEPTH_ATTACHMENT, b.RENDERBUFFER, g);
                                    b.clearDepth(1)
                                },
                                bind: function(H, I) {
                                ...
                                resize: function(H, I) {
                                    v = H;
                                    C = I;
                                    g && (b.bindRenderbuffer(b.RENDERBUFFER, g), b.renderbufferStorage(b.RENDERBUFFER, b.DEPTH_COMPONENT16, v, C))
                                },
                                remove: function() {
                                    E === a || x || (b.bindFramebuffer(c, E), b.framebufferTexture2D(c, b.COLOR_ATTACHMENT0, b.TEXTURE_2D, null, 0), g && b.framebufferRenderbuffer(c, b.DEPTH_ATTACHMENT, b.RENDERBUFFER,
                                        null), b.bindFramebuffer(c, null), b.deleteFramebuffer(E), g && b.deleteRenderbuffer(g));
                                    x = !0
                                }
                            };
                            r.vd && p.je();
                    ...
                    x = {
                        A: function() {
                            ...
                            if (!q.xd) {
                                ...
                                t.GL_EXT_FLOAT = q.Ac;
                                q.Bd = q.Ac ? !0 : !1;
                                if (q.Bd || x.la()) q.Bc = x.fd(k), q.gf = q.Bc ? !0 : !1, t.GL_EXT_FLOATLINEAR = q.Bc;
                                q.xd = !0
                            }
                            if (!q.yd) {
                                q.Cc = x.Za(k);
                                q.Cc && (q.Cd = !0, t.GL_EXT_HALFFLOAT = q.Cc);
                                if (q.Cd || x.la()) q.Dc = x.gd(k), t.GL_EXT_HALFFLOATLINEAR = q.Dc;
                                q.Zg = q.Dc ? !0 : !1;
                                q.yd = !0
                            }
                            q.Hb = x.cd(k);
                        ...
                        cd: c.bind(null, ["EXT_color_buffer_float", "WEBGL_color_buffer_float", "OES_color_buffer_float"]),
                        dd: c.bind(null, ["EXT_color_buffer_half_float", "WEBGL_color_buffer_half_float", "OES_color_buffer_half_float"]),
                        ed: c.bind(null, ["OES_texture_float", "MOZ_OES_texture_float", "WEBKIT_OES_texture_float"]),
                        fd: c.bind(null, ["OES_texture_float_linear", "MOZ_OES_texture_float_linear", "WEBKIT_OES_texture_float_linear"]),
                        Za: c.bind(null, ["OES_texture_half_float", "MOZ_OES_texture_half_float", "WEBKIT_OES_texture_half_float"]),
                        gd: c.bind(null, ["OES_texture_half_float_linear", "MOZ_OES_texture_half_float_linear", "WEBKIT_OES_texture_half_float_linear"]),
                        Vb: function(k) {
                            var p = x.Za(k);
                            return p && p.HALF_FLOAT_OES ? p.HALF_FLOAT_OES :
                        ...
                        be: function(k) {
                            v = k;
                            !k && g.Oa && (b.deleteSync(g.ib), b.bindBuffer(g.X, null), g.Oa = !1)
                        },
                        Ab: function(k, p, H) {
                            function I() {
                            ...
                            k.framebufferTexture2D(k.FRAMEBUFFER, k.COLOR_ATTACHMENT0, k.TEXTURE_2D, M, 0);
                            if (k.checkFramebufferStatus(k.READ_FRAMEBUFFER || k.FRAMEBUFFER) !== k.FRAMEBUFFER_COMPLETE) return I(), !1;
                            xa.wc(k);
                        ...
                        Lb: function(k) {
                            ...
                            k.clearColor(0, 0, 0, 0);
                            k.clear(k.COLOR_BUFFER_BIT);
                            k.RGBA32F && x.Ab(k, k.RGBA32F, k.FLOAT) && (p.ja = !0, E = k.RGBA32F);
                            !p.ja && x.Ab(k, k.RGBA, k.FLOAT) && (p.ja = !0, E = k.RGBA);
                            var H = x.Vb(k);
                            C = null;
                            k.RGBA16F && x.Ab(k, k.RGBA16F, H) && (p.ka = !0, C = k.RGBA16F);
                        ...
                        Ee: function() {
                            ...
                            p.u();
                            b.flush();
                            b.checkFramebufferStatus(la.Ue()) !== b.FRAMEBUFFER_COMPLETE ? (Ba.Df(), l.Tb = !1) : l.Tb = !0;
                            k.remove();
                            p.remove()
                        },
                        Fe: function() {
                            var k = !1;
                            x.la() && (k = "PIXEL_PACK_BUFFER STREAM_READ SYNC_GPU_COMMANDS_COMPLETE WAIT_FAILED fenceSync deleteSync createBuffer".split(" ").every(function(p) {
                        ...
                        xb: function(k, p, H, I, N) {
                            if (!x.ue()) return b.readPixels(k, p, H, I, b.RGBA, b.UNSIGNED_BYTE, N), Promise.resolve(N);
                            null === g.va && (g.X = b.PIXEL_PACK_BUFFER, g.va = b.createBuffer(), g.Yb = -1);
                            b.bindBuffer(g.X,
                                g.va);
                            N.byteLength !== g.Yb && (b.bufferData(g.X, N.byteLength, b.STREAM_READ), g.Yb = N.byteLength);
                                ...
                                function M() {
                                    ...
                                    switch (b.clientWaitSync(g.ib, 0, 0)) {
                                        ...
                                        case b.WAIT_FAILED:
                                            return !1;
                                        default:
                                            return d(), b.deleteSync(g.ib), b.getBufferSubData(g.X, 0, N), b.bindBuffer(g.X, null), z(N), !0
                                    }
                                }
                                d();
                                g.Oa = !0;
            ...
            Ca = function() {
                function a(J, M, u, f) {
                    p.texParameteri(p.TEXTURE_2D, p.TEXTURE_MIN_FILTER, f ? p.NEAREST_MIPMAP_NEAREST : p.LINEAR);
                    var y = null;
                    if (null !== u) try {
                        y = p.getError();
                    ...
                    y = p.getError();
                    y === p.INVALID_OPERATION && "undefined" !== typeof p.PIXEL_PACK_BUFFER && (p.bindBuffer(p.PIXEL_PACK_BUFFER, null), p.readPixels(0, 0, 2, 2, p.RGBA, p.UNSIGNED_BYTE, C), y = p.getError());
                    if (y !== p.NO_ERROR) return !1;
                    u = !0;
                ...
                function c(J, M) {
                    return H.ja && a(J, p.FLOAT, new Float32Array(E), M) ? (r = q.Nc, !0) : !1
                }
                ...
                function d(J, M, u) {
                    ...
                    var f = Ba.ze(E),
                        y = aa.Za(p);
                    if (y && y.HALF_FLOAT_OES && a(J, y.HALF_FLOAT_OES, f, M) || p.HALF_FLOAT && a(J, p.HALF_FLOAT, f, M)) return r = q.Ga, !0;
                    f = new Float32Array(E);
                    if (a(J, p.FLOAT, f, M)) return r = q.Ga, !0;
                    p.bindTexture(p.TEXTURE_2D, u);
                    p.texImage2D(p.TEXTURE_2D, 0, p.RGBA, 2, 2, 0, p.RGBA, p.UNSIGNED_BYTE, null);
                ...
                for (var q = {
                        ...
                        ud: null,
                        Xa: null
                    }, v = !0, C = new Uint8Array(16), E = Array(64), g = 0; 4 > g; ++g)
                    for (var t = 0; 4 > t; ++t) {
                        var x = 0 === (t + g) % 2 ? 1 : 0,
                            k = 4 * g + t;
                        E[4 * k] = x;
                ...
                return {
                    instance: function(a) {
                        var c = null,
                            ...
                            q = !1,
                            r = null,
                            l = "undefined" === typeof a.preprocessing ?
                            !1 : a.preprocessing,
                            v = "undefined" === typeof a.preprocessingSize ? a.size : a.preprocessingSize;
                        a.mask && (d = !0, ba && void 0 !== ba.oe && (a.mask = ba.oe + a.mask), c = Y.instance({
                            isFloat: !1,
                            url: a.mask
                        }));
                        var C = !1;
                        a.customInputShader && (C = "s45", A.Pc({
                            name: "_",
                            id: C,
                        ...
                        var E = Y.instance({
                            ...
                            g = {
                                ...
                                V: function(t) {
                                    va.ha();
                                    "abort" !== r && ("none" !== r && (A.set(r), n && A.G("u28", 1 / a.size), E.da(), d && c.g(1), U.l(!1, !1), E.g(0), t = E), e && m.process(t))
                                },
                                m: function() {
                                    E.remove();
                                    d && c.remove()
            ...
            Hb = function() {
                return {
                    instance: function(a) {
                        ...
                        a.ff ? (a.sparsity = "undefined" !== typeof a.sparsity ? a.sparsity : a.vb.Wb(), l = !1) : "full" === a.connectivityUp && (a.sparsity = a.vb.Wb());
                        var k = {
                                elu: "s16",
                                elu01: "s17",
                                relu: "s15",
                        ...
                        var L = {
                            ...
                            Ef: function() {
                                switch (a.connectivityUp) {
                                    ...
                                    case "full":
                                        ...
                                        break;
                                    case "conv":
                                        v = a.kernelsCount, G = dc.instance(a.connectivity), C && (d.tb = Y.instance({
                                            width: I,
                                            isFloat: !0,
                                            isFlipY: !1,
                                            isPot: !1
                            ...
                            V: function(h, F) {
                                e = h;
                                G.Ca ? (d.input.da(), E && d.Ua.g(2), G.V(x), d.input.g(0), d.input.Le(y), d.bc.da(), E ? A.set("s0") : (A.set("s28"), A.G("u26", p), d.Ua.g(1)), d.input.re(y, 0), U.l(!1, !1), A.set(k), z ? M.u() : d.ba.u(), d.bc.g(0), t && g.He(), U.l(!1, !1)) : (d.ba.da(), d.Ua.g(1), G.V());
                                z && (A.set(J), u.u(), M.g(0), U.l(!1, !1), A.set("s47"), A.G("u7", 1), d.ba.u(), u.g(1), U.l(!1, !1));
                                if (l) return H ? (d.oc.da(), d.ba.g(0), A.set(N), A.sa("u8", 1 / a.size, 1 / a.size), U.l(!1, !1), F = d.oc) :
                                    F = d.ba, F.g(0), C && (d.tb.u(), A.set("s22"), A.sa("u13", v, I / v), U.l(!1, !1), F = d.tb, d.tb.g(0)), F;
                                var K = d.ba;
                                a.normalize && (A.set("gpuRawAvg" === q ? "s9" : "s8"), A.G("u4", 1 / a.size), d.pc.da(), d.ba.g(0), U.l(!1, !1), K = d.pc);
                                h = null;
                                switch (q) {
                                    case "cpuRGBA2Float":
                                        K.Zc(!1);
                            ...
                            Be: function(h) {
                                ...
                                for (var F = 0, K = 0, P = 0; F < h; ++F) m.push(K + (a.size - 1 - P) * a.size), n.push([-1, -1, -1, -1]), ++K, K === a.size && (K = 0, ++P);
                                a.normalize && (d.pc = Y.instance({
                                    isFloat: !0,
                                    isPot: !0,
                                    width: a.size
                                }))
                        ...
                        return {
                            ...
                            V: function(e) {
                                if (e.isEnabled) {
                                    A.set("s25");
                                    e.kf.g(3);
                                    var m, n = Math.min(e.pb.length, e.depth);
            ...
            ac = function() {
                return {
                    instance: function(a) {
                        for (var c = a.fromLayerSize, d = a.toLayerSize, e = a.toSparsity, m = e * d, n = m / c, q = c / d, r = 0, l = 0, v = 0, C = Array(e * d * e * d * 4), E = Array(e * d * e * d * 4), g = Array(c * c), t = 0; t < g.length; ++t) g[t] = 0;
                        t = Math.floor(e / 2);
                        for (var x = .5 / d, k = .5 / c, p = .5 / m, H = 0; H < d; ++H)
                ...
                return {
                    instance: function(a, c) {
                        var d = a.fromLayerSize,
                            ...
                            C = "s48" + [d.toString(), e.toString(), m.toString(), n.toString(), c].join("_");
                        A.Je(C) || (a = Vb.Me(c, "gl_FragColor", "gl_FragColor"), e = [{
                            type: "1f",
                            name: "u17",
                            value: e
                        }, {
                            ...
                            name: "u25",
                            value: d
                        }), d = [(r ? q : m).toFixed(1), a], r && d.push(l.toFixed(1)), A.sd(r ? "s40" : "s39", C, d), A.T(C, e.concat([{
                            type: "1i",
                            name: "u15",
                            value: 0
                        }, {
                    ...
                    instance: function(a) {
                        ...
                        return {
                            process: function(E) {
                                ...
                                U.l(m, !1);
                                A.set("s37");
                                for (var g = 0; g < c; ++g) n.u(), A.sa("u8", C, 0), U.l(m, !1), r.u(), l.g(0), U.l(m, !1), q.u(), n.g(0), A.sa("u8", 0, C), U.l(m, !1), l.u(), r.g(0), U.l(m, !1), g !== c - 1 && q.g(0);
                                A.set("s38");
                                v.u();
                                E.g(0);
                                q.g(1);
                    ...
                    instance: function(a) {
                        ...
                        return {
                            process: function() {
                                ...
                                U.l(d.mb, !1);
                                A.set("s51");
                                for (var v = 0; 3 > v; ++v) A.sa("u32", 1, 0), m[v].u(), r[v].g(0), U.l(!1, !1), A.sa("u32", 0, 1), n[v].u(), m[v].g(0), U.l(!1, !1);
                                A.set("s52");
                                q.u();
                                e.g(0);
                                n[0].g(1);
            ...
            W = {
                ...
                xe: function() {
                    var a = !1,
                        c = navigator.userAgent || navigator.vendor ||
                        window.opera;
                ...
                Ag: function() {
                    return W.xe() ? W.Dd() ? window.innerHeight / window.innerWidth * 45 : 45 : 45
                },
                Yc: function() {
                ...
                Ae: function(a) {
                    function c(g) {
                        return [480, 576, 640, 648, 720, 768, 800, 960, 1080, 1152, 1280, 1366, 1920].sort(function(t, x) {
                    ...
                    if (a.video.width && a.video.height) {
                        if (a.video.width.ideal && a.video.height.ideal) {
                            var n =
                                ...
                                r = {},
                                l = 0;
                            for (r.na = void 0; l < n.length; r = {
                                    na: r.na
                                }, ++l) {
                                r.na = n[l];
                                var v = {},
                                    C = 0;
                                for (v.ma = void 0; C < q.length; v = {
                                        ma: v.ma
                                    }, ++C)
                                    if (v.ma = q[C], r.na !== a.video.width.ideal || v.ma !== a.video.height.ideal) {
                                        var E = Math.max(r.na, v.ma) / Math.min(r.na, v.ma);
                                        E < 4 / 3 - .1 || E > 16 / 9 + .1 || d(function(g, t) {
                                            return function(x) {
                    ...
                    a.video.width && a.video.height && (a.video.width.ideal &&
                        a.video.height.ideal && d(function(g) {
                ...
                ce: function(a, c, d) {
                    return null === a ? Promise.resolve() : new Promise(function(e, m) {
                        if (a.srcObject && a.srcObject.getVideoTracks) {
                            var n =
                                a.srcObject.getVideoTracks();
                            1 !== n.length ? m("INVALID_TRACKNUMBER") : (n = n[0], c ? W.get(a, e, m, d) : (n.stop(), e()))
                ...
                qd: function(a, c, d, e) {
                    ...
                    var n = !1;
                    return navigator.mediaDevices.getUserMedia(e).then(function(q) {
                        function r() {
                            setTimeout(function() {
                                if (a.currentTime) {
                                    var v = a.videoWidth,
                                    ...
                                    if (0 === v || 0 === C) m("VIDEO_NULLSIZE");
                                        ...
                                        try {
                                            var E =
                                                q.getVideoTracks()[0];
                                            E && (v.lf = E, v.ve = E.getCapabilities(), v.If = E.getSettings())
                                        } catch (g) {}
                                        W.we() ? a.parentNode && null !== a.parentNode ? (n || c(a, q, v), setTimeout(function() {
                                            a.play()
                                        }, 100)) : (document.body.appendChild(a), W.rb(a), n || c(a, q, v), setTimeout(function() {
                        ...
                        function l() {
                            ...
                            var v = a.play();
                            W.rb(a);
                            "undefined" === typeof v ? r() : v.then(function() {
                                r()
                            }).catch(function() {
                ...
                Ye: function(a) {
                    if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices) return a(!1, "NOTSUPPORTED"),
                        !1;
            ...
            pa = function() {
                ...
                var c = {
                    ...
                    g = {
                        ...
                        Fg: function(t) {
                            return Math.pow(Math.min(Math.max(r, 0), e.n - 1) / (e.n - 1), t || 1)
                        },
                        A: function(t) {
                            e = Object.assign({}, c, t);
                            r = l = e.kc;
                        ...
                        ae: function(t) {
                            ...
                            t - n > e.Qf && 5 < ++q && (x = e.k, r = r * (1 - x) + (m < e.bb[0] ? l - 1 : m > e.bb[1] ? l + 1 : l) * x, Math.abs(r - l) > 1 - e.tf && (x = Math.min(Math.max(Math.round(r), 0), e.n - 1), x !== l && (r = l = x, m = (e.bb[1] - e.bb[0]) / 2)), n = t)
                        },
            ...
            Ma = function() {
                ...
                function c() {
                    ...
                    N.Sa = 0 === f ? window.requestAnimationFrame(d) : window.requestAnimationFrame(e)
                }

                function d(f) {
                    I.ya && null !== x && (f -= k, f = Math.min(Math.max(f, t.$c[0]), t.$c[1]), k += f, n(), z.isEnabled && z.Y && I.Z && k - z.fc > t.Lc && (v(), z.fc = k), x(k))
                }
                ...
                function q(f) {
                    f && !I.Z ?
                        (I.Z = !0, H && pa.Gc(), p.port.postMessage("STOP"), aa.be(!0), c()) : !f && I.Z && (I.Z = !1, H && pa.vc(1), aa.be(!1), p.port.postMessage("START"))
                }
                ...
                function v() {
                    ...
                    E().then(function(h) {
                        ...
                        if (++z.Ed > t.Ea) {
                            ...
                            z.$a = Math.max(z.$a, h);
                            var F;
                            for (F = 0; F < z.Ec && !(h > z.$a * (1 - (t.Kc[F] + t.he * (F >= z.Bb ? 1 : -1)))); ++F) F === z.Ec - 1 && ++F;
                            F !== z.Bb && (console.log("THERMAL THROTTLING LEVEL = " + F.toString()), z.Bb = F, z.ga = 0 === F ? 0 : t.fe[F - 1], t.Ic && t.Ic(F))
                        }
                        z.Y = !0
                    }).catch(function() {
                        z.Y = !0
                ...
                function C(f) {
                    var y = z.fb,
                        G = z.gb,
                        L = z.hb;
                    L = z.za ? G.Cg(L, G.QUERY_RESULT_AVAILABLE_EXT) : y.getQueryParameter(L, y.QUERY_RESULT_AVAILABLE);
                    y = y.getParameter(G.GPU_DISJOINT_EXT);
                    L ? f(!y) : setTimeout(C.bind(null, f), .1)
                }
                    ...
                    return new Promise(function(f, y) {
                        C(function(G) {
                            if (G) {
                                ...
                                var L = z.gb,
                                    h = z.hb;
                                G = z.za ? L.getQueryObjectEXT(h, L.QUERY_RESULT_EXT) : G.getQueryParameter(h, G.QUERY_RESULT);
                                f(G)
                            } else y()
                        })
                    })
                    ...
                    u = {
                        A: function(f) {
                            ...
                            if (t.ie) {
                                ...
                                if (y = f.getExtension("EXT_disjoint_timer_query") || f.getExtension("EXT_disjoint_timer_query_webgl2")) {
                                    z.fb = f;
                                    z.gb = y;
                                    z.isEnabled = !0;
                                    z.za = y.beginQueryEXT ? !0 : !1;
                                    var G = l(f,
                                            f.VERTEX_SHADER, "attribute vec4 a0;void main(){gl_Position=a0;}"),
                                        L = l(f, f.FRAGMENT_SHADER, "precision lowp float;uniform float u37;void main(){vec4 a=u37*vec4(1.,2.,3.,4.);for(int b=0;b<666;b+=1)a=cos(a);gl_FragColor=a;}".replace("666", t.Jc.toString())),
                                        h = f.createProgram();
                                    f.attachShader(h, G);
                                    f.attachShader(h, L);
                                    f.linkProgram(h);
                                    ...
                                    f.bufferData(f.ARRAY_BUFFER,
                                        new Float32Array([.5, .5, 0, 1]), f.STATIC_DRAW);
                            ...
                            if (t.zd) {
                                ...
                                try {
                                    if ("undefined" === typeof SharedWorker) {
                                        var F = URL.createObjectURL(new Blob(["let handler = null;\n      self.addEventListener('message', function(e){\n        if (handler !== null){\n          clearTimeout(handler);\n          handler = null;\n        }\n        switch (e.data) {\n          case 'START':\n          case 'DONE':\n            handler = setTimeout(function(){\n              self.postMessage('TICK');\n            }, " + t.jc.toString() + ");\n            break;\n          case 'STOP':\n            break;\n        };\n      }, false);"], {
                                        ...
                                        var P = URL.createObjectURL(new Blob(["let handler = null;\n      onconnect = function(e) {\n        const port = e.ports[0];\n        port.addEventListener('message', function(e) {\n          \n          if (handler !== null){\n            clearTimeout(handler);\n            handler = null;\n          }\n          switch (e.data) {\n            case 'START':\n            case 'DONE':\n              handler = setTimeout(function(){\n                port.postMessage('TICK');\n              }, " +
                                                t.jc.toString() + ");\n              break;\n            case 'STOP':\n              break;\n          };\n          \n        });\n        \n        port.start();\n      } // end onconnect()"
                                            ], {
                                                type: "text/javascript"
                                            })),
                                ...
                                f && ("onvisibilitychange" in document ? document.addEventListener("visibilitychange", r) : (window.addEventListener("blur", M), window.addEventListener("focus", J)), I.cc = !0)
                            }
                            H = "undefined" !== typeof pa
                        },
                        m: function() {
                            m();
                            I.cc && ("onvisibilitychange" in document ? document.removeEventListener("visibilitychange", r) : (window.removeEventListener("blur", M), window.removeEventListener("focus", J)), I.cc = !1);
                            I.dc ? (p.port.close(), I.dc = !1) : I.ec && (p.Pd.terminate(), I.ec = !1);
                            Object.assign(I, {
                                Z: !0,
                                qa: !1,
                                ya: !1
                    ...
                    A: function(n) {
                        ...
                        for (var E = 0; E < c.Kd; ++E) {
                            ...
                            var k = x * q,
                                p = t / 2;
                            x /= 2;
                            for (var H = 1 + (1 - p - p) / g, I = 1 + (1 - x - x) / k, N = 0; N < I; ++N)
                                for (var z = x + N * k, J = z - .5, M = 0; M < H; ++M) {
                                    var u = p + M * g,
                                        f = u - .5;
                                    f * f + J * J > C || d.push([u, z, t * c.sf])
                                }
                        }
                        c.Ud && d.sort(function(y,
                            G) {
                            var L = y[0] - .5;
                            y = y[1] - .5;
                            var h = G[0] - .5;
            ...
            Eb = {
                ...
                init: function(a) {
                    function c() {
                        na !== ia.error && 2 === ++e && (Ja(), xb(), Ia(), Q.Ka && (na = ia.ready, Q.Ka(!1, {
                            GL: b,
                            canvasElement: Q.ia,
                    ...
                    if (na !== ia.lc) return a.callbackReady && a.callbackReady("ALREADY_INITIALIZED"), !1;
                    na = ia.jf;
                    B = Object.assign({}, ec);
                    Q = Object.assign({}, fc);
                    Z = Object.assign({}, gc);
                    ...
                    "undefined" !==
                    typeof a.animateDelay && (Q.fa = a.animateDelay);
                    "undefined" !== typeof a.NNCPath && (Q.Mc = a.NNCPath);
                    "undefined" !== typeof a.NNC && (Q.Fa = a.NNC);
                    "undefined" !== typeof a.maxFacesDetected && (O.o = Math.max(1, a.maxFacesDetected));
                    "undefined" !== typeof a.followZRot && (Q.ua = a.followZRot ? !0 : !1);
                    ...
                    for (var d = 0; d < O.o; ++d) hb.push(new Float32Array(ba.qf)), ib.push(0);
                    Ma.A({
                        zd: a.isKeepRunningOnWinFocusLost || !1,
                        ga: Q.fa
                    });
                    pa.A({
                        kc: 0,
                    ...
                    a.scanSettings && (Object.assign(ea, a.scanSettings), -1 !== ea.nDetectsPerLoop ? pa.vc(ea.nDetectsPerLoop) : pa.Gc());
                    sa = Object.create(ba.Jf);
                    a.stabilizationSettings && Object.assign(sa, a.stabilizationSettings);
                    var e = 0;
                    a.videoSettings && a.videoSettings.videoElement ? $a(a.videoSettings.videoElement,
                        c) : (a.videoSettings && Object.assign(oa, a.videoSettings), zb(a.onWebcamAsk, a.onWebcamGet, function(m) {
                        $a(m, c)
                    }));
                    Qb(function(m) {
                        if (!Rb()) return !1;
                ...
                destroy: function() {
                    ...
                    return new Promise(function(a) {
                        Eb.toggle_pause(!0, !0).finally(function() {
                            Oa && Oa.m();
                            Qa.m();
                            Oa = qa = Sa = null;
                            hb.splice(0);
                ...
                toggle_pause: function(a, c) {
                    ...
                    var d = null;
                    d = B.jb ? Promise.resolve() : c ? W.ce(B.element, !a, B.La) : Promise.resolve();
                    a ? rb() : d.then(function() {
                        eb()
                    });
                    return d
                },
                update_videoSettings: function(a) {
                    ...
                    return new Promise(function(c, d) {
                        W.ce(B.element, !1, B.La).then(function() {
                            Object.assign(oa, a);
                ...
                toggle_slow: function(a) {
                    Ya() && na === ia.play && (a && !Q.lb ? (Q.Od = Q.fa, ea.nDetectsPerLoop = 1, this.set_animateDelay(ba.Vf), Q.lb = !0) : !a && Q.lb && (ea.nDetectsPerLoop = -1, this.set_animateDelay(Q.Od), Q.lb = !1))
                },
                ...
                set_scanSettings: function(a) {
                    Object.assign(ea, a); - 1 !==
                        ea.nDetectsPerLoop ? pa.vc(ea.nDetectsPerLoop) : pa.Gc();
                    kb();
                    jb()
                },
